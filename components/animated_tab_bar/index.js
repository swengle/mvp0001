...
var BottomTabNavigator = function (_a) {
    var initialRouteName = _a.initialRouteName, backBehavior = _a.backBehavior, children = _a.children, screenOptions = _a.screenOptions, tabBarOptions = _a.tabBarOptions, options = _a.options, appearance = _a.appearance, rest = __rest(_a, ["initialRouteName", "backBehavior", "children", "screenOptions", "tabBarOptions", "options", "appearance"]);
    ...
    var finalTabBarOptions = __assign(__assign(__assign({}, defaultTabBarOptions), tabBarOptions), options);
    return (React__namespace.createElement(TabBarElement, __assign({}, rest, { state: state, navigation: navigation, descriptors: descriptors, tabBarOptions: finalTabBarOptions, appearance: finalAppearance, lazy: screenOptions.lazy || false })));
};
